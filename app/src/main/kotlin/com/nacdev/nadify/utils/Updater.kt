...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/NadifyGroup/Nadify"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Nadify.apk" -> "universal" to "foss"
                name == "Nadify-with-Google-Cast.apk" -> "universal" to "gms"
