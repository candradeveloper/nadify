...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.nacdev.nadify.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.nacdev.nadify.widget.LIKE"
        const val ACTION_NEXT = "com.nacdev.nadify.widget.NEXT"
        const val ACTION_PREVIOUS = "com.nacdev.nadify.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.nacdev.nadify.widget.UPDATE_WIDGET"
    }
}
