...
import com.nacdev.nadify.constants.ContentCountryKey
import com.nacdev.nadify.constants.ContentLanguageKey
import com.nacdev.nadify.constants.CountryCodeToName
import com.nacdev.nadify.constants.EnableBetterLyricsKey
import com.nacdev.nadify.constants.EnableKugouKey
import com.nacdev.nadify.constants.EnableLrcLibKey
import com.nacdev.nadify.constants.EnablePaxsenixKey
import com.nacdev.nadify.constants.EnableLyricsPlus
...
import com.nacdev.nadify.constants.LanguageCodeToName
import com.nacdev.nadify.constants.LyricsProviderOrderKey
import com.nacdev.nadify.constants.ProxyEnabledKey
import com.nacdev.nadify.constants.ProxyPasswordKey
import com.nacdev.nadify.constants.ProxyTypeKey
import com.nacdev.nadify.constants.ProxyUrlKey
import com.nacdev.nadify.constants.ProxyUsernameKey
import com.nacdev.nadify.constants.QuickPicks
import com.nacdev.nadify.constants.QuickPicksKey
import com.nacdev.nadify.constants.RandomizeHomeOrderKey
import com.nacdev.nadify.constants.SYSTEM_DEFAULT
import com.nacdev.nadify.constants.ShowArtistDescriptionKey
import com.nacdev.nadify.constants.ShowMostStatsPlaylistsKey
import com.nacdev.nadify.constants.ShowArtistSubscriberCountKey
import com.nacdev.nadify.constants.ShowMonthlyListenersKey
import com.nacdev.nadify.constants.ShowWrappedCardKey
...
import com.nacdev.nadify.ui.component.DraggableLyricsProviderItem
import com.nacdev.nadify.ui.component.DraggableLyricsProviderList
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.nacdev.nadify.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.nacdev.nadify.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.nacdev.nadify.db.entities.PlaylistEntity(
                        id = com.nacdev.nadify.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.nacdev.nadify.db.entities.PlaylistEntity(
                        id = com.nacdev.nadify.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
