            ...
            remember {
                songSelection
                    .map { song ->
                        ...
                        val metadata = song.toMediaMetadata()
                        com.nacdev.nadify.db.entities.Song(
                            song =
                                com.nacdev.nadify.db.entities.SongEntity(
                                    id = metadata.id,
                            ...
                            artists =
                                metadata.artists.map { artist ->
                                    com.nacdev.nadify.db.entities.ArtistEntity(
                                        id = artist.id ?: "",
                                        name = artist.name,
                                    )
                                },
                            album =
                                metadata.album?.let { album ->
                                    com.nacdev.nadify.db.entities.AlbumEntity(
                                        id = album.id,
                                        title = album.title,
