...
import com.nacdev.nadify.constants.ListenTogetherAutoApprovalKey
import com.nacdev.nadify.constants.ListenTogetherAutoApproveSuggestionsKey
import com.nacdev.nadify.constants.ListenTogetherIsHostKey
import com.nacdev.nadify.constants.ListenTogetherRoomCodeKey
import com.nacdev.nadify.constants.ListenTogetherServerUrlKey
import com.nacdev.nadify.constants.ListenTogetherSessionTimestampKey
import com.nacdev.nadify.constants.ListenTogetherSessionTokenKey
import com.nacdev.nadify.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "com.nacdev.nadify.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "com.nacdev.nadify.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "com.nacdev.nadify.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "com.nacdev.nadify.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(com.nacdev.nadify.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.dataStore.edit { preferences ->
                    preferences[com.nacdev.nadify.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {
