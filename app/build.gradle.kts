...
val baseApplicationId = "com.nacdev.nadify"
val applicationIdOverride = System.getenv("NADIFY_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("NADIFY_APP_NAME")?.takeIf { it.isNotBlank() }
val debugKeystorePathOverride = System.getenv("NADIFY_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("NADIFY_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("NADIFY_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("NADIFY_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
...
android {
    ...
    defaultConfig {
        ...
        versionCode = 146
        versionName = "13.4.2"
        resValue("string", "app_name", appNameOverride ?: "Nadify")
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "Nadify Debug")
            }
            signingConfig =
