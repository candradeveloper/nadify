package com.nadify.paxsenix

import android.content.Context
import com.nacdev.nadify.betterlyrics.TTMLParser
import com.nadify.paxsenix.models.LyricsResponse
import com.nadify.paxsenix.models.SearchResponse
import com.nadify.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "Nadify/$appVersion")
                }
